...
def generate_launch_description():
    ...
    return LaunchDescription(
        [
            ...
            DeclareLaunchArgument("gui", default_value=os.path.join(get_package_share_directory("carter_navigation"), "maps", "inspection_robot.usd"), description="Path to isaac sim scene"),
